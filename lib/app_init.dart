...
class _AppInitState extends BaseScreen<AppInit> {
  ...
  Future<void> loadInitData() async {
    try {
      ...
      if (ServerConfig().isBuilder) {
        printLog('[getting hereee] Init Data 💫');
      ...
      printLog('[error] getting to error 💫');
      printLog(e.toString());
  ...
  void goToNextScreen() {
    printLog('[nextscreencheck] getting here ohh 💫');
